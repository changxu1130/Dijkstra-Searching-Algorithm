...
//////////////////////////////////////////////////////////////////////
// Given an index, last completed color, game infor, check wether its 
// surrounding cells is free, return the number of not free cells

int n_not_free_surrounding(int i, const game_info_t* info, 
