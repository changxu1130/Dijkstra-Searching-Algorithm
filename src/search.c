...
int game_dijkstra_search(const game_info_t* info,
	...
	//While no solution found (finding solution, not progress yet)
	...
	//loop through the priority queue and free the child 
